...
function createClient(servers, path, secure, bigint, poolOptions) {
...
Client.prototype.add = function(core, docs, options, callback) {
  ...
  return this.update(core, docs, options, callback);
};
...
Client.prototype.realTimeGet = function(core, ids, query, callback) {
  ...
  return this.get(core, this.REAL_TIME_GET_HANDLER, query, callback);
};
...
Client.prototype.addRemoteResource = function(core, options, callback) {
  ...
  return this.get(core, handler, query, callback);
};
...
Client.prototype.createAddStream = function(core, options) {
  var path = [this.options.path, core || '', this.UPDATE_JSON_HANDLER + '?' + querystring.stringify(options) + '&wt=json']
...
Client.prototype.commit = function(core, options, callback) {
  if (typeof(options) === 'function') {
    callback = options;
    options = {};
  }
  ...
  return this.update(core, data, callback);
};
...
Client.prototype.prepareCommit = function(core, callback) {
...
Client.prototype.softCommit = function(core, callback) {
  return this.update(core, {}, {
    softCommit: true
  }, callback);
};
...
Client.prototype.delete = function(core, field, text, options, callback) {
  if (typeof(options) === 'function') {
    callback = options;
    options = {};
  }
  ...
  return this.update(core, data, options, callback);
};
...
Client.prototype.deleteByRange = function(core, field, start, stop, options, callback) {
  if (typeof(options) === 'function') {
    callback = options;
    options = {};
  }
  ...
  return this.deleteByQuery(core, query, options, callback);
};
...
Client.prototype.deleteByID = function(core, id, options, callback) {
  if (typeof(options) === 'function') {
    callback = options;
    options = {};
  }
...
Client.prototype.deleteByQuery = function(core, query, options, callback) {
  if (typeof(options) === 'function') {
    callback = options;
    options = {};
  }
...
Client.prototype.deleteAll = function(core, options, callback) {
  return this.deleteByQuery(core, '*:*', options, callback);
};
...
Client.prototype.optimize = function(core, options, callback) {
  if (typeof(options) === 'function') {
    callback = options;
    options = {};
  }
...
Client.prototype.rollback = function(core, callback) {
  var data = {
    rollback: {}
  };
  return this.update(core, data, callback);
...
Client.prototype.update = function(core, data, options, callback) {
  var self = this;
  if (typeof(options) === 'function') {
    callback = options;
    options = {};
  ...
  var fullPath = [this.options.path, core || '', this.UPDATE_JSON_HANDLER + '?' + querystring.stringify(options) + '&wt=json']
    .filter(function(element) {
      return element;
    })
    .join('/');
...
Client.prototype.search = function(core, query, callback) {
  return this.get(core, this.SELECT_HANDLER, query, callback);
};
...
Client.prototype.searchAll = function(core, callback) {
  return this.search(core, 'q=*', callback);
};
...
Client.prototype.spell = function(core, query, callback) {
  return this.get(core, this.SPELL_HANDLER, query, callback);
};
...
Client.prototype.get = function(core, handler, query, callback) {
  ...
  var fullPath = [this.options.path, core || '', handler + '?' + parameters + '&wt=json']
    .filter(function(element) {
      return element;
    })
    .join('/');
...
Client.prototype.ping = function(core, callback) {
  return this.get(core, this.ADMIN_PING_HANDLER, callback);
};
